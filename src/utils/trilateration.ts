import { Node, BeaconData, BeaconPosition, BeaconItem, LightItem } from '../types'

export function calculateBeaconPosition(data: BeaconItem, nodes: LightItem[]): BeaconPosition {
